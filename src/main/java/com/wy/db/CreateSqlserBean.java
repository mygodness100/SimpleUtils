...
/**
 * sqlserver批量或多表同时生成实体类,未开始
 * @author wanyang 2018年2月17日
 */
public class CreateSqlserBean {
	...
	public CreateSqlserBean(Connection conn, String[] tableNames, String dbName, String classAnnotationName,
	...
	public CreateSqlserBean(Connection conn, String dbName, String classAnnotationName,
			String primaryAnnotationName, String[] primaryColumns, String columnAnnotationName) {
		this.conn = conn;
		this.dbName = dbName;
		this.classAnnotationName = classAnnotationName;
	...
	public CreateSqlserBean(Connection conn, String[] tableNames,String dbName) {
		this(conn, tableNames, dbName,null);
	}
	
	public CreateSqlserBean(Connection conn, String dbName) {
