...
//
///**
// * oracle批量或多表同时生成实体类,未开始
// * @author wanyang 2018年2月17日
// */
//public class CreateOracleBean {
...
//			+ "\t\tthis.%s = %s;\r\n\t}\r\n\tpublic %s get%s(){\r\n" + "\t\treturn %s;\r\n\t}\r\n";
//
//	public CreateOracleBean(Connection conn, String[] tableNames, String dbName, String classAnnotationName,
...
//	}
//	
//	public CreateOracleBean(Connection conn, String dbName, String classAnnotationName,
//			String primaryAnnotationName, String[] primaryColumns, String columnAnnotationName) {
//		this.conn = conn;
//		this.dbName = dbName;
//		this.classAnnotationName = classAnnotationName;
...
//	}
//
//	public CreateOracleBean(Connection conn, String[] tableNames,String dbName) {
//		this(conn, tableNames, dbName,null);
//	}
//	
//	public CreateOracleBean(Connection conn, String dbName) {
